...
**Note:** <span color:>Modules</span> don't need <span style ="color:#DDA0DD">package.json</span> file, not all modules are packages, only those with `package.json` file are.
